...
if v:version >= 700
	...
	highlight CursorLine guifg=#443624  guibg=#E4CC98 gui=NONE
	highlight Pmenu guifg=#443624 guibg=#D9BB7A gui=NONE
	highlight PmenuSel guifg=#D9BB7A  guibg=#443624 gui=NONE
	highlight PmenuSbar guifg=#A52A2A guibg=#443624 gui=NONE
	highlight PmenuThumb guifg=#D9BB7A guibg=#E4CC98 gui=NONE
	highlight TabLine guifg=#443624 guibg=#FDD99B gui=underline
...
highlight DiffChange guifg=#CD853F guibg=#006A7F gui=NONE
highlight DiffDelete guifg=#E4CC98 guibg=#A52A2A gui=bold
highlight DiffText guifg=#1A1A1A guibg=#8D7748 gui=bold
...
highlight MatchParen guifg=#FDD99B guibg=#006A7F gui=NONE
...
highlight Search guifg=#FDD99B guibg=#007050 gui=NONE
